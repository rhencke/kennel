...
let preamble _state _name _comment _used_modules _safe =
  ...
  str "from typing import Callable, Generic, Iterable, Iterator, Protocol, TypeVar, assert_never" ++ fnl () ++
